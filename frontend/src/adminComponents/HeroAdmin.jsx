...
const AdminHero = () => {
  ...
  return (
    <section
      id="home"
      className="font-serif min-h-screen w-screen flex items-center flex-col "
    >
      ...
      <h1 className="text-white font-bold text-3xl text-center mt-3">
        Admin panel
      </h1>
      ...
      <div
        ...
        className="bg-stone-300 cursor-pointer w-11/12 h-16 flex justify-center items-center rounded-xl mt-3"
      >
